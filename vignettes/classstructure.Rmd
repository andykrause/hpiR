...
| | `rt` | `hpidata`, `data.frame` | **rtCreateTrans()** | Data.frame of repeat transactions with standardized field names |
| | `hed` | `hpidata`, `data.frame` | **hedCreatTrans()** | Data.frame of transactions with some standardized field names for use in hedonic model approach |
||||||
| **Model** | | | | |
