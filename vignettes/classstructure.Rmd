...
This vignette explains the various classes of objects and data used in the `hpiR` package. All example object found in this vignette (signified by the "ex_" prefix) are also contained in the package itself.  
