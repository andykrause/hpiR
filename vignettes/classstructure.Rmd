...
| | `seriesaccuracy` | `indexaccuracy` | **calcSeriesAccuracy()** | Calculate the period, mean and median revision |
||||||
| **Visualization** | | | | |
...
| | `plotaccuracy` | `gtable`, `gTree`, `grob`, `gDesc` | **plot.indexaccuracy()** | Plotting object for a error results|
