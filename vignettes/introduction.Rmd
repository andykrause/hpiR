...
```{r eval=TRUE, messages=FALSE, echo=TRUE}
  ...
  error_df <- data.frame(rs = round(as.numeric(summary(abs(rs_fc_error$pred_error))), 3),
                         hed = round(as.numeric(summary(abs(hed_hpi$fc_error$pred_error))), 3))
...
<!--   names(error_df) <- c('Repeat Sales', 'Hedonic Model') -->
<!--   rownames(error_df) <- c("Min", '25th', 'Median', 'Mean', '75th', 'Max')  -->
<!--   knitr::kable(error_df) -->
...
<!--   rs_series <- calcIndexSeries(hpi_obj = rs_hpi, -->
<!--                                train_period = 24, -->
<!--                                max_period = 84) -->
<!--   hed_series <- calcIndexSeries(hpi_obj = hed_hpi, -->
<!--                                 train_period = 24, -->
...
<!--   blend_index <- blendIndexes(index_list = list(rs_series, -->
<!--                                                 hed_series), -->
<!--                               weights=c(.6, .4)) -->
