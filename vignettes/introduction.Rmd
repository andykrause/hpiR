...
<!--   rs_hpi <- rsIndex(sales_df = rs_sales, -->
<!--                     estimator = 'robust', -->
<!--                     log_dep = TRUE, -->
<!--                     trim_model = FALSE, -->
<!--                     max_period = 84) -->

<!--   hed_hpi <- hedIndex(sales_df = hed_sales, -->
<!--                       estimator = 'weighted', -->
<!--                       log_dep = TRUE, -->
<!--                       trim_model = FALSE, -->
<!--                       max_period = 84, -->
...
<!--  index_vol <- calcIndexVolatility(index = hed_hpi$index$index, -->
<!--                                   window = 3) -->
...
<!--  # hpiindex object -->
<!--  index_vol <- calcIndexVolatility(index = hed_hpi$index, -->
<!--                                   window = 3) -->

<!--  # hpi object -->
<!--  index_vol <- calcIndexVolatility(index = hed_hpi, -->
<!--                                   window = 3) -->
...
<!--    hed_hpi$index <- calcIndexVolatility(index = hed_hpi$index, -->
<!--                                       window = 3, -->
<!--                                       in_place = TRUE) -->

<!--    class(hed_hpi$index$vol) -->

<!--    # Add it to the full 'hpi' object (to the hpiindex object) -->
<!--    hed_hpi <- calcIndexVolatility(index = hed_hpi, -->
<!--                                 window = 3, -->
<!--                                 in_place = TRUE) -->
<!--    class(hed_hpi$index$vol) -->
