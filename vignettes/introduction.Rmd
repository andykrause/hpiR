...
First, we use the `rsCreateSales` function to convert the raw transaction data (the **sales_df** object) into a data.frame of repeat sale (properties that have sold multiple times in the 2010 to 2016 period.)
